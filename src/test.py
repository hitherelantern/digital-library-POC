...
path = r'Business,finance and economics\A Man for All Markets.pdf'
folder  = r'..\Business,finance and economics'
x = os.path.join(folder)
files = os.listdir(x)
print(len(files))


print(os.path.basename(path) in pdf_values)
print(len(pdf_values))
print(pdf_values)
